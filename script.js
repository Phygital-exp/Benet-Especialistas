...
const API_URL = 'https://benet-especialistas-production.up.railway.app/api/benet/pdv';
...
function initializeFuse() {
    const options = {
        keys: ['DOCUMENTO','FARMACIA','NOMBRE','TELEFONO','EMAIL'],
        threshold: 0.3,
    };
        ...
        results.forEach(result => {
            output += `
                <div class="result-item">
                    ...
                    <ul>
                        <li>
                            <strong>Documento:</strong> ${result.DOCUMENTO} 
                            <i class="material-icons copy-icon" onclick="copyToClipboard('${result.DOCUMENTO}')">content_copy</i>
                        </li>
